    ...
    return (
      <div id="firstPage">
        <form onSubmit={handlePage1Submit} className="subSignUpPage">
          ...
          <p id="terms">
            By clicking Agree & Join, you have read the LinkedUp{" "}
            <a
              target="_blank"
              rel="noreferrer"
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/chan-kevin/LinkedUp/wiki"
            >
              Wiki Page
            </a>
            .
          ...
          <p id="hasAcc">
            Already on LinkedUp?{" "}
            <NavLink to="/login" id="hasAccSignIn">
              Sign in
            </NavLink>
          </p>
        </form>
